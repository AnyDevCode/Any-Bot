      ...
      if(message.attachments.size) {
        ...
        if(args[0].includes('youtube.com') || args[0].includes('youtu.be')) {
          if (ytdl.validateURL(args[0])) {
            ...
            song = { title: song_info.videoDetails.title, url: song_info.videoDetails.video_url, type: 'youtube', requester: message.author.id, duration: duration, thumbnail: song_info.videoDetails.thumbnails[0].url };
        } else {
            ...
            if (video){
                song = { title: video.title, url: video.url, type: 'youtube', requester: message.author.id, duration: video.duration.timestamp, thumbnail: video.thumbnail };
            } else {
          ...
          song = { url: args[0], title: args[0].split('/').pop(), type: 'attachment', requester: message.author.id, duration: 'Unknown', thumbnail: 'https://media.discordapp.net/attachments/779357529859686441/923005881250091008/Any_Bot_404.png?width=480&height=480' };
        } else {
